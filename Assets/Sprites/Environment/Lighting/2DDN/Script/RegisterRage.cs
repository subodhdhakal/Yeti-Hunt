...
public class RegisterRage : MonoBehaviour {
	/// <summary>
	...
	void OnDestroy () {
		...
		if (spriteRend != null) {
			rageCycle.Handler.DelRenderer (spriteRend, animated);
		}
		if (miscRend != null) {
			rageCycle.Handler.DelRenderer (miscRend);
		}
